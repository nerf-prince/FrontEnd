...
function RegisterPage({ onNavigateBack, onNavigateToLogin, onNavigateToLanding }: RegisterPageProps) {
  ...
  const handleRegister = () => {
    ...
    // După înregistrare, poți naviga la login
    // onNavigateToLogin()
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 lg:p-10 transform transition-transform duration-300">
          <h1 className="text-4xl font-bold text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-8">
            Alătură-te comunității InfoBac
          </h1>
